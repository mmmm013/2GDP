/**
 * config/creators.ts
 * GPM 4PE-MSC Creator Registry — single source of truth for all creator identities,
 * roles, and portal submission scopes.
 *
...
export interface Creator {
  ...
  role: string;
  scope: CreatorScope[];
  /** For Awesome Squad pairing (ZG ↔ MSJ) */
  pairedWith?: CreatorBrand;
  /** Friendly description shown in portal header */
  tagline: string;
  /** Portal route: /creator/[portalSlug] */
  portalSlug: string;
}
...
export const CREATORS: Creator[] = [
  ...
  },
  {
    ...
    // Two distinct scopes: blog writing + 2hr playlist curation
...
export const SCOPE_ACCEPT: Record<CreatorScope, string[]> = {
  ...
  HERB_BLOG:        ['text/plain'],   // blog posts submitted via portal rich-text editor
  GPM_FP_PLAYLIST:  ['application/json'], // serialised playlist JSON from drag-sort UI
};
