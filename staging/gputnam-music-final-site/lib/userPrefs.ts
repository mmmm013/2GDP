/**
 * lib/userPrefs.ts — GPM User Preference Store (staging)
 *
...
import { FOUNDER_DEFAULTS, type AvatarMode } from '../config/founderDefaults';
...
export function defaultAvatarForMood(mood: string, bpm?: number): AvatarMode {
  ...
  if (moodLo.includes('ski') || moodLo.includes('snow')) return 'skier';
