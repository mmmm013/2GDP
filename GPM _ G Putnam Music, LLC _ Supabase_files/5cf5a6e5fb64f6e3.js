...
`,m=t.z.object({id:t.z.string(),table_id:t.z.number(),schema:t.z.string(),table:t.z.string(),name:t.z.string(),ordinal_position:t.z.number(),data_type:t.z.string(),format:t.z.string(),is_identity:t.z.boolean(),identity_generation:t.z.string().nullable(),is_generated:t.z.boolean(),is_nullable:t.z.boolean(),is_updatable:t.z.boolean(),is_unique:t.z.boolean(),check:t.z.string().nullable(),default_value:t.z.any().nullable(),enums:t.z.array(t.z.string()),comment:t.z.string().nullable()}),u=t.z.array(m),p=t.z.optional(m),_=e=>e.endsWith("[]")?`${(0,i.ident)(e.slice(0,-2))}[]`:e.includes(".")?e:(0,i.ident)(e),g=`
SELECT
  name,
  setting,
  category,
...
ORDER BY
  category,
  name
`,$=t.z.object({name:t.z.string(),setting:t.z.string(),category:t.z.string(),group:t.z.string(),subgroup:t.z.string(),unit:t.z.string().nullable(),short_desc:t.z.string(),extra_desc:t.z.string().nullable(),context:t.z.string(),vartype:t.z.string(),source:t.z.string(),min_val:t.z.string().nullable(),max_val:t.z.string().nullable(),enumvals:t.z.array(t.z.string()).nullable(),boot_val:t.z.string().nullable(),reset_val:t.z.string().nullable(),sourcefile:t.z.string().nullable(),sourceline:t.z.number().nullable(),pending_restart:t.z.boolean()}),b=t.z.array($),f=`
SELECT
  e.name,
  n.nspname AS schema,
  e.default_version,
...
`,h=t.z.object({name:t.z.string(),schema:t.z.string().nullable(),default_version:t.z.string(),installed_version:t.z.string().nullable(),comment:t.z.string()}),E=t.z.array(h),z=t.z.optional(h),A=`
select
  c.oid::int8 as id,
  n.nspname as schema,
  c.relname as name,
...
where
  c.relkind = 'f'
`,y=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),comment:t.z.string().nullable(),foreign_server_name:t.z.string(),foreign_data_wrapper_name:t.z.string(),foreign_data_wrapper_handler:t.z.string(),columns:u.optional()}),S=t.z.array(y),T=t.z.optional(y),v=({includeColumns:e})=>`
with foreign_tables as (${A})
  ${e?`, columns as (${d})`:""}
select
  *
  ${e?`, ${a("columns","columns.table_id = foreign_tables.id")}`:""}
from foreign_tables`,N=`
...
`,w=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),language:t.z.string(),definition:t.z.string(),complete_statement:t.z.string(),args:t.z.array(t.z.object({mode:t.z.union([t.z.literal("in"),t.z.literal("out"),t.z.literal("inout"),t.z.literal("variadic"),t.z.literal("table")]),name:t.z.string(),type_id:t.z.number(),has_default:t.z.boolean()})),argument_types:t.z.string(),identity_argument_types:t.z.string(),return_type_id:t.z.number(),return_type:t.z.string(),return_type_relation_id:t.z.union([t.z.number(),t.z.null()]),is_set_returning_function:t.z.boolean(),behavior:t.z.union([t.z.literal("IMMUTABLE"),t.z.literal("STABLE"),t.z.literal("VOLATILE")]),security_definer:t.z.boolean(),config_params:t.z.union([t.z.record(t.z.string(),t.z.string()),t.z.null()])}),L=t.z.array(w),R=t.z.optional(w);function I({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o}={}){let l=`
    ...
    select
      f.*
    from f
  `,s=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return s&&(l+=` where schema ${s}`),a&&(l=`${l} limit ${a}`),o&&(l=`${l} offset ${o}`),{sql:l,zod:L}}function O({id:e,name:t,schema:n="public",args:a=[]}){if(e)return{sql:`
      with f as (
        ${N}
      )
      select
        f.*
      from f where id = ${(0,i.literal)(e)};`,zod:R};if(t&&n&&a)return{sql:`with f as (
      ${N}
    )
    select
      f.*
  ...
  `}function D({name:e,schema:n="public",args:i=[],definition:a,return_type:r="void",language:o="sql",behavior:l="VOLATILE",security_definer:s=!1,config_params:c={}}){return{sql:x({name:e,schema:n,args:i,definition:a,return_type:r,language:o,behavior:l,security_definer:s,config_params:c}),zod:t.z.void()}}let j=t.z.object({name:t.z.string().optional(),schema:t.z.string().optional(),definition:t.z.string().optional()});function M(e,{name:n,schema:a,definition:r}){let o=e.argument_types.split(", "),l=e.identity_argument_types,s="string"==typeof r?x({...e,definition:r,args:o,config_params:e.config_params??{}},{replace:!0}):"",c=n&&n!==e.name?`ALTER FUNCTION ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.name)}(${l}) RENAME TO ${(0,i.ident)(n)};`:"",d=a&&a!==e.schema?`ALTER FUNCTION ${(0,i.ident)(e.schema)}.${(0,i.ident)(n||e.name)}(${l})  SET SCHEMA ${(0,i.ident)(a)};`:"";return{sql:`
    DO LANGUAGE plpgsql $$
    BEGIN
    ...
    END;
    $$;
  `,zod:t.z.void()}}let U=t.z.object({cascade:t.z.boolean().default(!1).optional()});function F(e,{cascade:n=!1}={}){return{sql:`DROP FUNCTION ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.name)}
  (${e.identity_argument_types})
  ${n?"CASCADE":"RESTRICT"};`,zod:t.z.void()}}e.s(["create",()=>D,"list",()=>I,"pgFunctionArrayZod",0,L,"pgFunctionCreateZod",0,C,"pgFunctionDeleteZod",0,U,"pgFunctionOptionalZod",0,R,"pgFunctionUpdateZod",0,j,"pgFunctionZod",0,w,"remove",()=>F,"retrieve",()=>O,"update",()=>M],198687);var k=e.i(198687);let H=`
  SELECT
...
where
  c.relkind = 'm'
`,Y=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),is_populated:t.z.boolean(),comment:t.z.string().nullable(),columns:u.optional()}),G=t.z.array(Y),Q=t.z.optional(Y),J=({includeColumns:e})=>`
...
`,em=t.z.object({id:t.z.number(),name:t.z.string(),owner:t.z.string(),comment:t.z.string().nullable()}),eu=t.z.array(em),ep=t.z.optional(em),e_=`
...
group by
  ...
  c.relname,
  c.relkind
`,eg=t.z.object({relation_id:t.z.number(),schema:t.z.string(),name:t.z.string(),kind:t.z.union([t.z.literal("table"),t.z.literal("view"),t.z.literal("materialized_view"),t.z.literal("foreign_table"),t.z.literal("partitioned_table")]),privileges:t.z.array(t.z.object({grantor:t.z.string(),grantee:t.z.string(),privilege_type:t.z.union([t.z.literal("SELECT"),t.z.literal("INSERT"),t.z.literal("UPDATE"),t.z.literal("DELETE"),t.z.literal("TRUNCATE"),t.z.literal("REFERENCES"),t.z.literal("TRIGGER"),t.z.literal("MAINTAIN")]),is_grantable:t.z.boolean()}))}),e$=t.z.array(eg),eb=t.z.optional(eg),ef=`
SELECT
  c.oid :: int8 AS id,
  nc.nspname AS schema,
  c.relname AS name,
...
group by
  ...
  nc.nspname,
  pk.primary_keys
`,eh=t.z.object({table_id:t.z.number(),name:t.z.string(),schema:t.z.string(),table_name:t.z.string()}),eE=t.z.object({id:t.z.number(),constraint_name:t.z.string(),source_schema:t.z.string(),source_table_name:t.z.string(),source_column_name:t.z.string(),target_table_schema:t.z.string(),target_table_name:t.z.string(),target_column_name:t.z.string()}),ez=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),rls_enabled:t.z.boolean(),rls_forced:t.z.boolean(),replica_identity:t.z.enum(["DEFAULT","INDEX","FULL","NOTHING"]),bytes:t.z.number(),size:t.z.string(),live_rows_estimate:t.z.number(),dead_rows_estimate:t.z.number(),comment:t.z.string().nullable(),primary_keys:t.z.array(eh),relationships:t.z.array(eE),columns:u.optional()}),eA=t.z.array(ez);function ey({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o,includeColumns:l=!0}={}){let s=ev({includeColumns:l}),c=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return c&&(s+=` where schema ${c}`),a&&(s+=` limit ${a}`),o&&(s+=` offset ${o}`),{sql:s,zod:eA}}function eS(e){let t=function(e){if("id"in e&&e.id)return`${(0,i.ident)("id")} = ${(0,i.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return`${(0,i.ident)("name")} = ${(0,i.literal)(e.name)} and ${(0,i.ident)("schema")} = ${(0,i.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e);return{sql:`${ev({includeColumns:!0})} where ${t};`,zod:ez}}function eT(e,{cascade:t=!1}={}){return{sql:`DROP TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.name)} ${t?"CASCADE":"RESTRICT"};`}}let ev=({includeColumns:e})=>`
  with tables as (${ef})
  ${e?`, columns as (${d})`:""}
  select
    *
    ${e?`, ${a("columns","columns.table_id = tables.id")}`:""}
  from tables`;function eN({name:e,schema:t="public",comment:n}){let a=`CREATE TABLE ${(0,i.ident)(t)}.${(0,i.ident)(e)} ();`,r=void 0!=n?`COMMENT ON TABLE ${(0,i.ident)(t)}.${(0,i.ident)(e)} IS ${(0,i.literal)(n)};`:"";return{sql:`BEGIN; ${a} ${r} COMMIT;`}}function ew(e,{name:t,schema:n,rls_enabled:a,rls_forced:r,replica_identity:o,replica_identity_index:l,primary_keys:s,comment:c}){let d=`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.name)}`,m=void 0===n?"":`${d} SET SCHEMA ${(0,i.ident)(n)};`,u="";if(void 0!==t&&t!==e.name){let a=void 0===n?e.schema:n;u=`ALTER TABLE ${(0,i.ident)(a)}.${(0,i.ident)(e.name)} RENAME TO ${(0,i.ident)(t)};`}let p="";if(void 0!==a){let e=`${d} ENABLE ROW LEVEL SECURITY;`,t=`${d} DISABLE ROW LEVEL SECURITY;`;p=a?e:t}let _="";if(void 0!==r){let e=`${d} FORCE ROW LEVEL SECURITY;`,t=`${d} NO FORCE ROW LEVEL SECURITY;`;_=r?e:t}let g="";void 0===o||(g="INDEX"===o?`${d} REPLICA IDENTITY USING INDEX ${l};`:`${d} REPLICA IDENTITY ${o};`);let $="";void 0===s||($+=`
DO $$
DECLARE
  r record;
BEGIN
...
END
$$;
`,0===s.length||($+=`${d} ADD PRIMARY KEY (${s.map(e=>(0,i.ident)(e.name)).join(",")});`));let b=void 0==c?"":`COMMENT ON TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.name)} IS ${(0,i.literal)(c)};`;return{sql:`
BEGIN;
  ${p}
  ${_}
  ${g}
  ...
  ${m}
  ${u}
COMMIT;`}}e.s(["create",()=>eN,"list",()=>ey,"remove",()=>eT,"retrieve",()=>eS,"update",()=>ew],330006);var eL=e.i(330006);let eR=`
SELECT
  pg_t.oid AS id,
...
`,eD=t.z.object({id:t.z.number(),name:t.z.string(),schema:t.z.string(),format:t.z.string(),enums:t.z.array(t.z.string()),attributes:t.z.array(t.z.object({name:t.z.string(),type_id:t.z.number()})),comment:t.z.string().nullable()}),ej=t.z.array(eD),eM=`
select
  version(),
...
`,eU=t.z.object({version:t.z.string(),version_number:t.z.number(),active_connections:t.z.number(),max_connections:t.z.number()}),eF=`
SELECT
  c.oid :: int8 AS id,
  n.nspname AS schema,
  c.relname AS name,
...
create role ${(0,i.ident)(e)}
  ...
  ${0===u.length?"":`in role ${u.map(i.ident).join(",")}`}
...
`}},update:function(e,t){let{name:n,isSuperuser:a,canCreateDb:r,canCreateRole:o,inheritRole:l,canLogin:s,isReplicationRole:c,canBypassRls:d,connectionLimit:m,password:u,validUntil:p}=t;return{sql:`
do $$
declare
  old record;
begin
  ...
  execute(format('alter role %I
    ...
    ${void 0===u?"":`password ${(0,i.literal)(u)}`}
...
where
 true
`,m=r(a,o,t?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return m&&(c+=` and schema ${m}`),void 0!==e&&(c+=` and table_id = ${(0,i.literal)(e)} `),l&&(c=`${c} limit ${l}`),s&&(c=`${c} offset ${s}`),{sql:c,zod:u}},retrieve:function(e){return{sql:`WITH columns AS (${d}) SELECT * FROM columns WHERE ${function(e){if("id"in e&&e.id)return`${(0,i.ident)("id")} = ${(0,i.literal)(e.id)}`;if("name"in e&&e.name&&e.schema&&e.table)return`schema = ${(0,i.literal)(e.schema)} AND ${(0,i.ident)("table")} = ${(0,i.literal)(e.table)} AND name = ${(0,i.literal)(e.name)}`;throw Error("Must provide either id or schema, name and table")}(e)};`,zod:p}},create:function({schema:e,table:t,name:n,type:a,default_value:r,default_value_format:o="literal",is_identity:l=!1,identity_generation:s="BY DEFAULT",is_nullable:c,is_primary_key:d=!1,is_unique:m=!1,comment:u,check:p}){let g="";if(l){if(void 0!==r)throw Error("Columns cannot both be identity and have a default value");g=`GENERATED ${s} AS IDENTITY`}else void 0===r||(g="expression"===o?`DEFAULT ${r}`:`DEFAULT ${(0,i.literal)(r)}`);let $="";void 0!==c&&($=c?"NULL":"NOT NULL");let b=void 0===p?"":`CHECK (${p})`,f=void 0===u?"":`COMMENT ON COLUMN ${(0,i.ident)(e)}.${(0,i.ident)(t)}.${(0,i.ident)(n)} IS ${(0,i.literal)(u)}`;return{sql:`
BEGIN;
  ALTER TABLE ${(0,i.ident)(e)}.${(0,i.ident)(t)} ADD COLUMN ${(0,i.ident)(n)} ${_(a)}
    ...
    ${b};
  ${f};
COMMIT;`}},update:function(e,{name:t,type:n,drop_default:a=!1,default_value:r,default_value_format:o="literal",is_identity:l,identity_generation:s="BY DEFAULT",is_nullable:c,is_unique:d,comment:m,check:u}){let p,g,$=void 0===t||t===e.name?"":`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} RENAME COLUMN ${(0,i.ident)(e.name)} TO ${(0,i.ident)(t)};`,b=void 0===n?"":`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ALTER COLUMN ${(0,i.ident)(e.name)} SET DATA TYPE ${_(n)} USING ${(0,i.ident)(e.name)}::${_(n)};`;if(a)p=`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ALTER COLUMN ${(0,i.ident)(e.name)} DROP DEFAULT;`;else if(void 0===r)p="";else{let t="expression"===o?r:(0,i.literal)(r);p=`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ALTER COLUMN ${(0,i.ident)(e.name)} SET DEFAULT ${t};`}let f=`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ALTER COLUMN ${(0,i.ident)(e.name)}`;!1===l?f+=" DROP IDENTITY IF EXISTS;":!0===e.is_identity?void 0===s?f="":f+=` SET GENERATED ${s};`:void 0===l?f="":f+=` ADD GENERATED ${s} AS IDENTITY;`,g=void 0===c?"":c?`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ALTER COLUMN ${(0,i.ident)(e.name)} DROP NOT NULL;`:`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ALTER COLUMN ${(0,i.ident)(e.name)} SET NOT NULL;`;let h="";!0===e.is_unique&&!1===d?h=`
DO $$
DECLARE
  r record;
BEGIN
...
END
$$;
`:!1===e.is_unique&&!0===d&&(h=`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ADD UNIQUE (${(0,i.ident)(e.name)});`);let E=void 0===m?"":`COMMENT ON COLUMN ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)}.${(0,i.ident)(e.name)} IS ${(0,i.literal)(m)};`,z=void 0===u?"":`
DO $$
DECLARE
  v_conname name;
  v_conkey int2[];
BEGIN
  ...
  ${null!==u?`
  ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} ADD CONSTRAINT ${(0,i.ident)(`${e.table}_${e.name}_check`)} CHECK (${u});
...
BEGIN;
  ...
  ${z}
  ${$}
COMMIT;`}},remove:function(e,{cascade:t=!1}={}){return{sql:`ALTER TABLE ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)} DROP COLUMN ${(0,i.ident)(e.name)} ${t?"CASCADE":"RESTRICT"};`}},zod:m},schemas:{list:function({includeSystemSchemas:e=!1,limit:t,offset:a}={}){let r=ed;return e||(r=`${r} and not (n.nspname in (${n.DEFAULT_SYSTEM_SCHEMAS.map(i.literal).join(",")}))`),t&&(r=`${r} limit ${t}`),a&&(r=`${r} offset ${a}`),{sql:r,zod:eu}},retrieve:function({id:e,name:t}){return e?{sql:`${ed} and n.oid = ${(0,i.literal)(e)};`,zod:ep}:{sql:`${ed} and n.nspname = ${(0,i.literal)(t)};`,zod:ep}},create:function({name:e,owner:t}){return{sql:`create schema ${(0,i.ident)(e)}
...
$$;
`}},zod:em},tables:eL,functions:k,tablePrivileges:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o}={}){let l=`
with table_privileges as (${e_})
select *
from table_privileges
`,s=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return s&&(l+=` where schema ${s}`),a&&(l+=` limit ${a}`),o&&(l+=` offset ${o}`),{sql:l,zod:e$}},retrieve:function({id:e,name:t,schema:n="public"}){return e?{sql:`
with table_privileges as (${e_})
select *
from table_privileges
where table_privileges.relation_id = ${(0,i.literal)(e)};`,zod:eb}:{sql:`
with table_privileges as (${e_})
select *
from table_privileges
where table_privileges.schema = ${(0,i.literal)(n)}
  and table_privileges.name = ${(0,i.literal)(t)}
`,zod:eb}},grant:function(e){return{sql:`
do $$
begin
...
`}},remove:function(e){return{sql:`DROP PUBLICATION IF EXISTS ${(0,i.ident)(e.name)};`}},zod:en},extensions:{list:function({limit:e,offset:t}={}){let n=f;return e&&(n=`${n} LIMIT ${e}`),t&&(n=`${n} OFFSET ${t}`),{sql:n,zod:E}},retrieve:function({name:e}){return{sql:`${f} WHERE name = ${(0,i.literal)(e)};`,zod:z}},create:function({name:e,schema:t,version:n,cascade:a=!1}){return{sql:`
CREATE EXTENSION ${(0,i.ident)(e)}
  ${void 0===t?"":`SCHEMA ${(0,i.ident)(t)}`}
  ${void 0===n?"":`VERSION ${(0,i.literal)(n)}`}
  ${a?"CASCADE":""};`}},update:function(e,{update:t=!1,version:n,schema:a}){let r="";t&&(r=`ALTER EXTENSION ${(0,i.ident)(e)} UPDATE ${void 0===n?"":`TO ${(0,i.literal)(n)}`};`);let o=void 0===a?"":`ALTER EXTENSION ${(0,i.ident)(e)} SET SCHEMA ${(0,i.ident)(a)};`;return{sql:`BEGIN; ${r} ${o} COMMIT;`}},remove:function(e,{cascade:t=!1}={}){return{sql:`DROP EXTENSION ${(0,i.ident)(e)} ${t?"CASCADE":"RESTRICT"};`}},zod:h},config:{list:function({limit:e,offset:t}={}){let n=g;return e&&(n+=` LIMIT ${e}`),t&&(n+=` OFFSET ${t}`),{sql:n,zod:b}},zod:$},materializedViews:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o,includeColumns:l=!0}={}){let s=J({includeColumns:l}),c=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return c&&(s+=` where schema ${c}`),a&&(s+=` limit ${a}`),o&&(s+=` offset ${o}`),{sql:s,zod:G}},retrieve:function(e){let t=function(e){if("id"in e&&e.id)return`${(0,i.ident)("id")} = ${(0,i.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return`${(0,i.ident)("name")} = ${(0,i.literal)(e.name)} and ${(0,i.ident)("schema")} = ${(0,i.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e);return{sql:`${J({includeColumns:!0})} where ${t};`,zod:Q}},zod:Y},foreignTables:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o,includeColumns:l=!0}={}){let s=v({includeColumns:l}),c=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return c&&(s+=` where schema ${c}`),a&&(s+=` limit ${a}`),o&&(s+=` offset ${o}`),{sql:s,zod:S}},retrieve:function(e){return{sql:`${v({includeColumns:!0})} where ${function(e){if("id"in e&&e.id)return`${(0,i.ident)("id")} = ${(0,i.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return`${(0,i.ident)("name")} = ${(0,i.literal)(e.name)} and ${(0,i.ident)("schema")} = ${(0,i.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e)};`,zod:T}},zod:y},views:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o,includeColumns:l=!0}={}){let s=eB({includeColumns:l}),c=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return c&&(s+=` where schema ${c}`),a&&(s+=` limit ${a}`),o&&(s+=` offset ${o}`),{sql:s,zod:eH}},retrieve:function(e){let t=function(e){if("id"in e&&e.id)return`${(0,i.ident)("id")} = ${(0,i.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return`${(0,i.ident)("name")} = ${(0,i.literal)(e.name)} and ${(0,i.ident)("schema")} = ${(0,i.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e);return{sql:`${eB({includeColumns:!0})} where ${t};`,zod:eq}},zod:ek},policies:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o}={}){let l=`
    with policies as (${V})
    select *
    from policies
...
create policy ${(0,i.ident)(e)} on ${(0,i.ident)(t)}.${(0,i.ident)(n)}
  ...
  ${a?`using (${a})`:""}
  ${r?`with check (${r})`:""};`}},update:function(e,t){let{name:n,definition:a,check:r,roles:o}=t,l=`ALTER POLICY ${(0,i.ident)(e.name)} ON ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)}`,s=void 0===n?"":`${l} RENAME TO ${(0,i.ident)(n)};`,c=void 0===a?"":`${l} USING (${a});`,d=void 0===r?"":`${l} WITH CHECK (${r});`,m=void 0===o?"":`${l} TO ${o.map(i.ident).join(",")};`;return{sql:`BEGIN; ${c} ${d} ${m} ${s} COMMIT;`}},remove:function(e){return{sql:`DROP POLICY ${(0,i.ident)(e.name)} ON ${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)};`}},zod:X},triggers:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o}={}){let l=`with triggers as (${eR}) select * from triggers`,s=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return s&&(l+=` where schema ${s}`),a&&(l+=` limit ${a}`),o&&(l+=` offset ${o}`),{sql:l,zod:eO}},retrieve:function(e){let t=function(e){if("id"in e&&e.id)return`${(0,i.ident)("id")} = ${(0,i.literal)(e.id)}`;if("name"in e&&e.name&&e.table&&e.schema)return`${(0,i.ident)("name")} = ${(0,i.literal)(e.name)} and ${(0,i.ident)("schema")} = ${(0,i.literal)(e.schema)} and ${(0,i.ident)("table")} = ${(0,i.literal)(e.table)}`;throw Error("Must provide either id or name, schema and table")}(e);return{sql:`with triggers as (${eR}) select * from triggers where ${t};`,zod:eC}},create:function({name:e,schema:n="public",table:a,function_schema:r="public",function_name:o,function_args:l=[],activation:s,events:c,orientation:d,condition:m}){let u=`${(0,i.ident)(n)}.${(0,i.ident)(a)}`,p=`${(0,i.ident)(r)}.${(0,i.ident)(o)}`,_=c.join(" or "),g=d?`for each ${d}`:"",$=m?`when (${m})`:"",b=l.map(i.literal).join(",");return{sql:`create trigger ${(0,i.ident)(e)} ${s} ${_} on ${u} ${g} ${$} execute function ${p}(${b});`,zod:t.z.void()}},update:function(e,n){let a=`${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)}`,r="";switch(n.enabled_mode){case"ORIGIN":r=`alter table ${a} enable trigger ${(0,i.ident)(e.name)};`;break;case"DISABLED":r=`alter table ${a} disable trigger ${(0,i.ident)(e.name)};`;break;case"REPLICA":case"ALWAYS":r=`alter table ${a} enable ${n.enabled_mode} trigger ${(0,i.ident)(e.name)};`}let o=n.name&&n.name!==e.name?`alter trigger ${(0,i.ident)(e.name)} on ${a} rename to ${(0,i.ident)(n.name)};`:"";return{sql:`begin; ${r}; ${o}; commit;`,zod:t.z.void()}},remove:function(e,{cascade:n=!1}={}){let a=`${(0,i.ident)(e.schema)}.${(0,i.ident)(e.table)}`;return{sql:`drop trigger ${(0,i.ident)(e.name)} on ${a} ${n?"cascade":""};`,zod:t.z.void()}},zod:eI},types:{list:function({includeArrayTypes:e=!1,includeSystemSchemas:t=!1,includedSchemas:i,excludedSchemas:a,limit:o,offset:l}={}){let s=ex;e||(s+=` and not exists (
      select from pg_type el
      where el.oid = t.typelem
        and el.typarray = t.oid
    )`);let c=r(i,a,t?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return c&&(s+=` and n.nspname ${c}`),o&&(s+=` limit ${o}`),l&&(s+=` offset ${l}`),{sql:s,zod:ej}},zod:eD},version:{retrieve:function(){return{sql:eM,zod:eU}},zod:eU},indexes:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:a,offset:o}={}){let l=`
    with indexes as (${H})
    select *
    from indexes
  `,s=r(t,i,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return s&&(l+=` where schema ${s}`),a&&(l+=` limit ${a}`),o&&(l+=` offset ${o}`),{sql:l,zod:B}},retrieve:function({id:e}){return{sql:`
    with indexes as (${H})
    select *
    from indexes
    where id = ${(0,i.literal)(e)};
  `,zod:P}},zod:q},columnPrivileges:{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:a,columnIds:l,limit:s,offset:d}={}){let m=`
  with column_privileges as (${o})
  select *
  from column_privileges
  `,u=[],p=r(t,a,e?void 0:n.DEFAULT_SYSTEM_SCHEMAS);return p&&u.push(`relation_schema ${p}`),l?.length&&u.push(`column_id in (${l.map(i.literal).join(",")})`),u.length>0&&(m+=` where ${u.join(" and ")}`),s&&(m+=` limit ${s}`),d&&(m+=` offset ${d}`),{sql:m,zod:c}},grant:function(e){return{sql:`
do $$
declare
  col record;
begin
...
`}},zod:s},query:eJ,getIndexWorkerStatusSQL:()=>`SELECT EXISTS (
...
//# debugId=a445b8bd-d763-0297-04c3-45e87dff435c
//# sourceMappingURL=855d652cd8218188.js.map