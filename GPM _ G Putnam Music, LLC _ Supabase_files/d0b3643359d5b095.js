;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="a850471f-6f80-716f-c3ce-392d504c95be")}catch(e){}}();
(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,460988,e=>{"use strict";var t=e.i(156054),r=e.i(55956),s=e.i(784820),a=e.i(605031),o=e.i(389959);e.i(128328);var n=e.i(86086),i=e.i(884892),l=e.i(857054),u=e.i(993394);let c=e=>r.default.utc(Number(e)/1e3).toISOString(),d=e=>{let t=16===String(e).length;return!Number.isNaN(Number(e))&&t},g=(e,t)=>Object.keys(e).filter(t=>e[t]).flatMap(r=>{let s=t?`${t}.${r}`:r;return"object"==typeof e[r]?g(e[r],s):[s]}),p=(e,t)=>{let r=Object.keys(t),a=u.SQL_FILTER_TEMPLATES[e],o=e=>{let r=a[e],o=(0,s.default)(t,e);if(void 0!==o&&"function"==typeof r)return r(o);if(void 0===r)if("string"==typeof o)return`${e} = '${o}'`;else return`${e} = ${o}`;return void 0===o&&"function"==typeof r?null:r&&!1===o?null:r},n=r.map(e=>{if(void 0===t[e]||"string"==typeof t[e]&&0===t[e].length)return null;if("object"==typeof t[e]){let r=g(t[e],e).map(o).filter(Boolean);return r.length>0?`(${r.join(" or ")})`:null}{let t=o(e);return null===t?null:`(${t})`}}).filter(Boolean).join(" and ");return n?"where "+n:""},m=e=>{switch(e){case"edge_logs":return`cross join unnest(metadata) as m
  ...
  cross join unnest(m.request) as request`;case"supavisor_logs":return"cross join unnest(metadata) as m";default:return""}},f=n.IS_PLATFORM?"where ( parsed.application_name = 'pg_cron' or regexp_contains(event_message, 'cron job') )":"where ( parsed.application_name = 'pg_cron' or event_message::text LIKE '%cron job%' )",h=e=>{let t=e.reduce((e,t)=>{let r=_(t);return e[r]+=1,e},{second:0,minute:0,hour:0,day:0});return Object.keys(t).reduce((e,r)=>t[e]>t[r]?e:r)},_=e=>({0:"second",1:"minute",2:"hour",3:"day"})[["second","minute","hour"].map(t=>e.get(t)).reduce((e,t)=>(0===t&&(e+=1),e),0)];function y(e){let t=e.replace(/--.*$/gm,"").replace(/\/\*[\s\S]*?\*\//gm,"");return/\b(WITH)\b(?=(?:[^']*'[^']*')*[^']*$)/i.test(t)}function b(e){let t=e.replace(/--.*$/gm,"").replace(/\/\*[\s\S]*?\*\//gm,"");return/\b(ILIKE)\b(?=(?:[^']*'[^']*')*[^']*$)/i.test(t)}function v(e){let t=e?.[0]?.request?.[0]?.sb?.[0]?.jwt?.[0]?.apikey?.[0];if(!t)return;if(t.invalid)return"<invalid>";let r=t?.payload?.[0];return r&&"HS256"===r.algorithm&&"supabase"===r.issuer&&["anon","service_role"].includes(r.role)&&!r.subject?r.role:"<unrecognized>"}function S(e){let t=e?.[0]?.request?.[0]?.sb?.[0]?.apikey?.[0]?.apikey?.[0];if(t)return t.error?`${t.prefix}... <invalid: ${t.error}>`:`${t.prefix}...`}function E(e){let t=e?.[0]?.request?.[0]?.sb?.[0]?.jwt?.[0]?.authorization?.[0];if(!t||t.invalid)return;let r=t?.payload?.[0];if(r&&r.role)return r.role}e.s(["apiKey",()=>S,"checkForILIKEClause",()=>b,"checkForWithClause",()=>y,"fillTimeseries",0,(e,t,s,a,o,n,i=20,l)=>{let u;if(0===e.length&&!(o&&n))return[];if(e.length>i)return e.map(e=>{let s=e[t],a=d(s)?c(s):r.default.utc(s).toISOString();return e[t]=a,e});if(e.length<=1&&!(o&&n))return e;let g=e.map(e=>r.default.utc(e[t])),p=n?r.default.utc(n):r.default.utc(Math.max.apply(null,g)),m=o?r.default.utc(o):r.default.utc(Math.min.apply(null,g)),f=e.length>0?g:[m,p],_=1;if(l){let e=l.match(/^(\d+)(m|h|d|s)$/);e?(_=parseInt(e[1],10),u=({s:"second",m:"minute",h:"hour",d:"day"})[e[2]]):u=h(f)}else u=h(f);0!==e.length||l||(u="minute");let y=e.map(e=>{let a=e[t],o=d(a)?c(a):r.default.utc(a).toISOString();return Array.isArray(s)&&0===s.length?{[t]:o}:(e[t]=o,e)}),b=m;for(;b.isBefore(p)||b.isSame(p);){if(!g.find(e=>e.year()===b.year()&&e.month()===b.month()&&e.date()===b.date()&&e.hour()===b.hour()&&e.minute()===b.minute()&&e.second()===b.second())){let e=("string"==typeof s?[s]:s).reduce((e,t)=>({...e,[t]:a}),{});y.push({[t]:b.toISOString(),...e})}b=b.add(_,u)}return y},"genChartQuery",0,(e,t,s)=>{let a,o,n,i,l,c,[d,g]=(a=t.iso_timestamp_end?(0,r.default)(t.iso_timestamp_end):(0,r.default)(),o=t.iso_timestamp_start?(0,r.default)(t.iso_timestamp_start):(0,r.default)(),n="minute",i=360,l=a.diff(o,"minute"),c=a.diff(o,"hour"),l>720?(n="hour",i=120):c>72&&(n="day",i=7),[o.add(-i,n),n]),h=p(e,s),_=function(e){switch(e){case"edge_logs":case"function_edge_logs":return"response.status_code >= 500";case"postgres_logs":case"pg_cron_logs":return"parsed.error_severity IN ('ERROR', 'FATAL', 'PANIC')";case"auth_logs":return"metadata.level = 'error' OR SAFE_CAST(metadata.status AS INT64) >= 400";case"function_logs":return"metadata.level IN ('error', 'fatal')";default:return"false"}}(e),y=function(e){switch(e){case"edge_logs":case"function_edge_logs":return"response.status_code >= 400 AND response.status_code < 500";case"postgres_logs":return"parsed.error_severity IN ('WARNING')";case"auth_logs":return"metadata.level = 'warning'";case"function_logs":return"metadata.level IN ('warning')";default:return"false"}}(e);e===u.LogsTableName.PG_CRON&&(e=u.LogsTableName.POSTGRES,h=f);let b=m(e);return`
SELECT
-- log-event-chart
...
ORDER BY
  timestamp ASC
  `},"genCountQuery",0,(e,t)=>{let r=p(e,t);e===u.LogsTableName.PG_CRON&&(e=u.LogsTableName.POSTGRES,r=f);let s=m(e);return`SELECT count(*) as count FROM ${e} ${s} ${r}`},"genDefaultQuery",0,(e,t,r=100)=>{let s=p(e,t),a=m(e),o="order by timestamp desc";switch(e){case"edge_logs":if(!n.IS_PLATFORM)return`
...
`;return`select id, ${e}.timestamp, event_message, response.status_code, request.method, m.function_id, m.execution_time_ms, m.deployment_id, m.version from ${e}
  ...
  ${o}
  limit ${r}
  `;case"supavisor_logs":return`select id, ${e}.timestamp, event_message from ${e} ${a} ${s} ${o} limit ${r}`;case"pg_upgrade_logs":return`select id, ${e}.timestamp, event_message from ${e} ${a} ${s} ${o} limit 100`;default:return`select id, ${e}.timestamp, event_message from ${e}
  ${s}
  ${o}
  limit ${r}
  `;case"pg_cron_logs":let i=s?`${f} AND ${s.substring(6)}`:f;return`select id, postgres_logs.timestamp, event_message, parsed.error_severity, parsed.query
from postgres_logs
${a}
${i}
${o}
limit ${r}
`}},"genSingleLogQuery",0,(e,t)=>`select id, timestamp, event_message, metadata from ${e} where id = '${t}' limit 1`,"isDefaultLogPreviewFormat",0,e=>e&&e.timestamp&&e.event_message&&e.id,"isUnixMicro",0,d,"jwtAPIKey",()=>v,"maybeShowUpgradePromptIfNotEntitled",0,(e,t)=>!!t&&Math.abs((0,r.default)().diff((0,r.default)(e),"day"))>t,"role",()=>E,"unixMicroToIsoTimestamp",0,c,"useEditorHints",0,()=>{let e=(0,t.useMonaco)();(0,o.useEffect)(()=>{if(e){let t=e.languages.registerCompletionItemProvider("pgsql",{triggerCharacters:["`"," ","."],provideCompletionItems:function(t,r,s){let o=new i.default(t,r.column-2,r.lineNumber-1);if(o.isNextDQuote())return{suggestions:[]};let n=[],u=l.default.schemas.filter(e=>o._text.includes(e.reference));if(0===u.length&&(u=l.default.schemas),o.isNextPeriod()){let t=u.flatMap(e=>e.fields).flatMap(e=>{let[t,...r]=e.path.split(".");return r}).map(t=>({label:t,kind:e.languages.CompletionItemKind.Property,insertText:t}));n=n.concat(t)}if("`"===s.triggerCharacter||" "===s.triggerCharacter){let t=l.default.schemas.map(t=>({label:t.reference,kind:e.languages.CompletionItemKind.Class,insertText:t.reference})),r=u.flatMap(e=>e.fields).flatMap(e=>e.path.split(".").slice(0,-1)).map(t=>({label:t,kind:e.languages.CompletionItemKind.Property,insertText:t}));n=(n=n.concat(r)).concat(t)}return{suggestions:(0,a.default)(n,"label")}}});return()=>{t.dispose()}}},[e])}])},993394,e=>{"use strict";var t,r=e.i(55956),s=e.i(10429);e.i(128328);var a=e.i(86086);let o=`${s.DOCS_URL}/guides/platform/logs#querying-with-the-logs-explorer`,n=[{label:"Recent Errors",mode:"simple",searchString:"[Ee]rror|\\s[45][0-9][0-9]\\s",for:["api"]},{label:"Commits",mode:"simple",searchString:"COMMIT",for:["database"]},{label:"Commits By User",description:"Count of commits made by users on the database",mode:"custom",searchString:`select
  p.user_name,
  count(*) as count
from postgres_logs
