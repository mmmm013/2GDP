    ...
    <main className="min-h-screen w-full bg-gradient-to-b from-[#FFD54F] to-[#FF8F00] text-[#3E2723] font-sans selection:bg-[#3E2723] selection:text-[#FFD54F]">
      ...
      <div className="container mx-auto px-4 mt-16 text-center max-w-3xl">
        ...
        <p className="text-xl font-bold text-[#3E2723] opacity-80 mb-12 uppercase tracking-widest">Your Life. Your Story. Your Sound.</p>
                ...
                <p className="text-sm text-[#3E2723]/70 mt-4 max-w-md mx-auto leading-relaxed">
            URU is your personal audio fingerprint vault. Every snippet you unlock here is cryptographically tied to your identity, giving you exclusive sponsor-level access to preview tracks before they go public. Think of it as a VIP backstage pass that lives on the blockchain of sound — only you hold the key.
          </p>
